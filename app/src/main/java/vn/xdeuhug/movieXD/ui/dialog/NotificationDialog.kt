...
import vn.xdeuhug.movieXD.databinding.DialogNotificationBinding
...
class NotificationDialog {
    class Builder constructor(
        ...
        init {
            ...
            if (isCancelable)
                binding.btnConfirm.text = getString(vn.xdeuhug.movieXD.R.string.close)
            else
                binding.btnConfirm.text = getString(vn.xdeuhug.movieXD.R.string.confirm)
