...
import vn.xdeuhug.base.action.ActivityAction
import vn.xdeuhug.movieXD.R
import vn.xdeuhug.movieXD.other.AppConfig
import vn.xdeuhug.movieXD.ui.dialog.InputDialog
import vn.xdeuhug.movieXD.ui.dialog.MessageDialog
import vn.xdeuhug.movieXD.ui.dialog.TipsDialog
import vn.xdeuhug.widget.layout.NestedScrollWebView
import java.util.*
...
class BrowserView @JvmOverloads constructor(
    ...
    open class BrowserViewClient : WebViewClient() {
        ...
        @Deprecated("Deprecated in Java", ReplaceWith(
            ...
            "vn.xdeuhug.luckyMoney.webkit.WebViewClient"
        )
        )
        override fun onReceivedError(
            view: WebView,
