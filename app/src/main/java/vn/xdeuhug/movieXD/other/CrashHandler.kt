...
import vn.xdeuhug.movieXD.ui.activity.CrashActivity
import vn.xdeuhug.movieXD.ui.activity.RestartActivity
...
class CrashHandler private constructor(private val application: Application) :
    ...
    override fun uncaughtException(thread: Thread, throwable: Throwable) {
        ...
        // 不去触发系统的崩溃处理（com.vn.xdeuhug.luckyMoney.internal.os.RuntimeInit$KillApplicationHandler）
        if (nextHandler != null && !nextHandler.javaClass.name
                .startsWith("com.vn.xdeuhug.luckyMoney.internal.os")
        ) {
